...
class ParlDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        tensors = torch.LongTensor(data.user_review_in_one[index].copy()), \
                  ...
                  torch.LongTensor(data.user_auxiliary_review_in_one[index].copy()), \
...
def test():
    dataset = ParlDataset(DataSetEnum.Appliances, DataTypeEnum.Train)
