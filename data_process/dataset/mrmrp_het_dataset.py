...
class MrmrpHetDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        tensors = torch.LongTensor(data.user_review_in_one[index].copy()), \
                  ...
                  torch.LongTensor(data.user_ref_review_in_one[index].copy()), \
...
def test():
    dataset = MrmrpHetDataset(DataSetEnum.Appliances, DataTypeEnum.Train)
